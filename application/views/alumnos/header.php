            ...
            <div class="sidebar text-white">
                <nav class="sidebar-nav">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('alumnos/cursos')?>" class="nav-link">
                                <i class="fa fa-book"></i> Curso Actual
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="<?= base_url('alumnos/calificaciones')?>" class="nav-link">
                                <i class="fa fa-book"></i> Calificaciones
                            </a>
                        </li>

                        <li class="nav-item">
                                <a href="<?= base_url('alumnos/tareas')?>" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                                <a href="<?= base_url('alumnos/trayectoria')?>" class="nav-link">
                                    <i class="fa fa-graduation-cap"></i> Trayectoria academémica
                                </a>
                            </li>
                    </ul>
                </nav>
